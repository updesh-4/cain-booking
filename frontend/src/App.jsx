...
// //   // ✅ Merged and improved login success listener
// //   useEffect(() => {
// //     const handleMessage = (event) => {
// //       // Ensure the message is from a trusted origin (e.g., your domain)
// //       // This check is a security best practice.
// //       if (event.origin !== window.location.origin) return;

// //       if (event.data === "login-success") {
// //         navigate("/"); // Use navigate for cleaner client-side routing
// //       }
// //     };

// //     const handleStorageChange = (event) => {
// //       if (event.key === "otpSuccessFlag" && event.newValue === "true") {
...
// //     // Listen for storage changes from other tabs/windows (for broader compatibility)
...
// //         />
// //         <Route
// //           path="/events-shoots-and-advertising/:city"
// //           element={
// //             <>
// //               <EventsPage />
// //               <FormData />
